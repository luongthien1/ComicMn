...
namespace ML
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Program\Visual Studio\Project\ML\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.38870534F,L2Regularization=0.28250602F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
